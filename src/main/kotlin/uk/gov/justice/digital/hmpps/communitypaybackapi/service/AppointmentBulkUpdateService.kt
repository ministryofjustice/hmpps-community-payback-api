...
class AppointmentBulkUpdateService(
  ...
  private fun UpdateAppointmentOutcomesDto.apply() = updates.map { updateAppointmentOutcome ->
    val outcome = try {
      appointmentService.updateAppointmentOutcome(updateAppointmentOutcome)
