...
class ProjectService(
  ...
  fun getProjectAllocations(startDate: LocalDate, endDate: LocalDate, teamId: Long) = communityPaybackAndDeliusClient.getProjectAllocations(startDate, endDate, teamId).toDto()
}
