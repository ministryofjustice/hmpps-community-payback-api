...
class AppointmentMappersTest {
  ...
  @Nested
  inner class AppointmentDtoToSummaryDto {

    @Test
    fun `maps AppointmentDto to AppointmentSummaryDto successfully`() {
      val appointmentId = 123L
      val contactOutcomeCode = "OUTCOME1"
      every { contactOutcomeEntityRepository.findByCode(contactOutcomeCode) } returns ContactOutcomeEntity.valid().copy(name = "The outcome")

      val result = service.toSummaryDtoFromDto(
        appointmentDto = AppointmentDto.valid().copy(
          id = appointmentId,
          contactOutcomeCode = contactOutcomeCode,
          projectCode = "PROJ1",
          projectName = "Project 1",
          projectTypeCode = "PT1",
          projectTypeName = "Project Type 1",
          date = LocalDate.of(2025, 9, 1),
          startTime = LocalTime.of(10, 0),
          endTime = LocalTime.of(11, 0),
          minutesCredited = 576,
      ...
      assertThat(result.contactOutcome?.name).isEqualTo("The outcome")
      assertThat(result.requirementMinutes).isEqualTo(0)
      assertThat(result.adjustmentMinutes).isEqualTo(0)
      assertThat(result.completedMinutes).isEqualTo(0)
      assertThat(result.date).isEqualTo(LocalDate.of(2025, 9, 1))
      assertThat(result.startTime).isEqualTo(LocalTime.of(10, 0))
      assertThat(result.endTime).isEqualTo(LocalTime.of(11, 0))
      assertThat(result.minutesCredited).isEqualTo(576)
      ...
      assertThat(result.projectName).isEqualTo("Project 1")
      assertThat(result.projectTypeCode).isEqualTo("PT1")
      assertThat(result.projectTypeName).isEqualTo("Project Type 1")
      assertThat(result.notes).isEqualTo("Test notes")
    }

    @Test
    fun `handles null contactOutcomeCode`() {
      val appointmentId = 456L
      ...
      val result = service.toSummaryDtoFromDto(
        appointmentDto = AppointmentDto.valid().copy(
          ...
          projectTypeCode = "PT2",
          projectTypeName = "Project Type 2",
      ...
      assertThat(result.adjustmentMinutes).isEqualTo(0)
      assertThat(result.completedMinutes).isEqualTo(0)
      assertThat(result.date).isEqualTo(LocalDate.of(2025, 9, 2))
      assertThat(result.startTime).isEqualTo(LocalTime.of(14, 0))
      assertThat(result.endTime).isEqualTo(LocalTime.of(15, 0))
      assertThat(result.minutesCredited).isEqualTo(100)
      assertThat(result.daysOverdue).isNull()
      assertThat(result.projectCode).isEqualTo("PROJ2")
      assertThat(result.projectName).isEqualTo("Project 2")
      assertThat(result.projectTypeCode).isEqualTo("PT2")
      assertThat(result.projectTypeName).isEqualTo("Project Type 2")
      assertThat(result.notes).isEqualTo("Test notes 2")
    }
  }
