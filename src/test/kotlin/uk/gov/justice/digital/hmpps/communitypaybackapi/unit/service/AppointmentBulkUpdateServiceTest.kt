...
class AppointmentBulkUpdateServiceTest {
  ...
  inner class UpdateAppointmentOutcomes {
    ...
    fun `don't proceed if validation fails`() {
      ...
      every { appointmentUpdateValidationService.validateUpdate(appointment1Dto, update1) } just Runs
    ...
    fun `mix of all outcomes`() {
      ...
      every { appointmentUpdateValidationService.validateUpdate(any(), any()) } just Runs
