    ...
    fun `should map ContactOutcomeEntity list to DTO correctly`() {
      val contactOutcomes = listOf(
        ...
        ContactOutcomeEntity(
          ...
          hintText = "For example repeated lateness, arriving unfit or ill, leaving early without evidence, not wearing the right protective equipment",
          code = "AFTC",
          enforceable = true,
          attended = false,
          groups = emptyList(),
        ...
        ContactOutcomeEntity(
          ...
          displayName = null,
          hintText = "For example aggression, substance influence, refusal to comply with instructions, unsafe behaviour",
          code = "ATSH",
          enforceable = true,
          attended = false,
          groups = emptyList(),
