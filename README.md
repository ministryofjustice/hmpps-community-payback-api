...
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://hmpps-community-payback-api-dev.hmpps.service.justice.gov.uk/webjars/swagger-ui/index.html?configUrl=/v3/api-docs)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-community-payback-api/security/policy).
...
## Renaming from HMPPS Community Payback Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-community-payback-api=0
```
